...
set_property PACKAGE_PIN J2 [get_ports rx1]
set_property IOSTANDARD LVCMOS33 [get_ports rx1]

set_property PACKAGE_PIN A16 [get_ports tx2]
set_property IOSTANDARD LVCMOS33 [get_ports tx2]
set_property PACKAGE_PIN B15 [get_ports rx2]
set_property IOSTANDARD LVCMOS33 [get_ports rx2]

set_property PACKAGE_PIN M18 [get_ports tx3]
set_property IOSTANDARD LVCMOS33 [get_ports tx3]
set_property PACKAGE_PIN N17 [get_ports rx3]
set_property IOSTANDARD LVCMOS33 [get_ports rx3]

set_property -dict { PACKAGE_PIN T1    IOSTANDARD LVCMOS33 } [get_ports {sl2}]
set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports {sl1}]
